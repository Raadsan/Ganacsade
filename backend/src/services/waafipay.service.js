...
class WaafiPayService {
  ...
  async preAuthorize({ phoneNumber, amount, currency = 'USD', referenceId, description }) {
    ...
    try {
      console.log('WaafiPay PreAuthorize Request:', JSON.stringify(payload, null, 2));
      ...
      console.log('WaafiPay PreAuthorize Response:', JSON.stringify(response.data, null, 2));

      const { responseCode, responseMsg, params, errorCode } = response.data;
  ...
  async commitTransaction({ transactionId, referenceId, description }) {
    ...
    try {
      console.log('WaafiPay Commit Request:', JSON.stringify(payload, null, 2));
      ...
      console.log('WaafiPay Commit Response:', JSON.stringify(response.data, null, 2));
  ...
  async cancelTransaction({ transactionId, referenceId, description }) {
    ...
    try {
      console.log('WaafiPay Cancel Request:', JSON.stringify(payload, null, 2));
      ...
      console.log('WaafiPay Cancel Response:', JSON.stringify(response.data, null, 2));
  ...
  async reversePurchase(transactionId, description = 'Order cancelled') {
    ...
    try {
      console.log('WaafiPay Reversal Request:', JSON.stringify(payload, null, 2));
      ...
      console.log('WaafiPay Reversal Response:', JSON.stringify(response.data, null, 2));
   ...
   */
  async initiateHPP({ phoneNumber, amount, currency = 'USD', referenceId, description, successUrl, failureUrl }) {
    const requestId = uuidv4();
    const timestamp = new Date().toISOString();
    ...
    try {
      console.log('WaafiPay HPP Request:', JSON.stringify(payload, null, 2));
      ...
      console.log('WaafiPay HPP Response:', JSON.stringify(response.data, null, 2));
  ...
  async getHPPTransactionInfo(orderId) {
    ...
    try {
      console.log('WaafiPay HPP GetOrderInfo Request:', JSON.stringify(payload, null, 2));
      ...
      console.log('WaafiPay HPP GetOrderInfo Response:', JSON.stringify(response.data, null, 2));
